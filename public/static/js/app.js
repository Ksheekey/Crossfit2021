am4core.ready(function (init) {
        ...
        d3.csv("crossfit.csv", function (madison) {
            ...
            if (event == 2) {
                ...
                for (var i = 0; i < madison.length; i++) {
                    ...
                    scoreCell.textContent = s.event_2;
            ...
            if (event == 3) {
                d3.select("thead").html("")
                // document.getElementById("crossfit").reset();
                var t = document.createElement('table');
                t.classList.add('crossfit', 'events');
                t.appendChild(document.createElement('thead'));
                t.querySelector('thead').appendChild(document.createElement('tr'));
                ...
                for (var i = 0; i < madison.length; i++) {
                    ...
                    var scoreCell = document.createElement('td');
                    scoreCell.textContent = s.event_3;
    ...
    for (var g = 1; g < 16; g++) {
        ...
        // console.log(allData[g])
        // allData[g].forEach((d) => {
        // console.log(allData[g][d])
        // })
    }
    // console.log(athleteDict)
